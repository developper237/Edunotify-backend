...
const creerSession = async (req, res) => {
  try {
    ...
    const profId = req.headers['x-user-id'];
...
// ──────────────────────────────────────────────────────────────────
// GET /exam/sessions/:id — Infos de la session + sujets (pour l'étudiant connecté)
// ──────────────────────────────────────────────────────────────────
...
// ──────────────────────────────────────────────────────────────────
// POST /exam/sessions/:id/warning — Signaler un avertissement (caméra ou tentative de quit)
...
const signalerAvertissement = async (req, res) => {
  try {
    const { id } = req.params;
    const { type } = req.body; // 'camera' ou 'quit'
    const userId = req.headers['x-user-id'];
    ...
    if (nouveauTotal >= maxAvis) {
      // Invalider la session de l'étudiant
...
// Corrige les QCM et calcule les scores
// ──────────────────────────────────────────────────────────────────
