...
// ── Transporter Brevo (ex-Sendinblue) ─────────────────────────────
// Relais SMTP transactionnel — plus fiable que Gmail depuis un hébergeur
// cloud (pas de blocage IPv6/anti-spam comme rencontré avec Gmail sur Render).
const transporter = nodemailer.createTransport({
  host: process.env.SMTP_HOST || 'smtp-relay.brevo.com',
  port: Number(process.env.SMTP_PORT) || 587,
  secure: false, // port 587 = STARTTLS, pas de TLS implicite
  auth: {
